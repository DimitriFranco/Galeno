...
def get_assets_path():
    """ Retorna o caminho base correto para a pasta assets """
    if hasattr(sys, '_MEIPASS'):
        return os.path.join(sys._MEIPASS, 'assets')
    return os.path.abspath("assets")

ASSETS_DIR = get_assets_path()
IMG_LOGO_PATH = os.path.join(ASSETS_DIR, "galeno_icon.png")
IMG_CRRG_PATH = os.path.join(ASSETS_DIR, "carregar_icon.png")
IMG_DESCON_PATH = os.path.join(ASSETS_DIR, "desconectado.png")
IMG_CONECT_PATH = os.path.join(ASSETS_DIR, "conectado.png")
...
class Plato_App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.img_logo = customtkinter.CTkImage(light_image=Image.open(IMG_LOGO_PATH), size=(40, 40))
        ...
        def confirmar_id():
            ...
            conexao, url, key = logica.login_zotero(id_user, api_key, tipo)
            if conexao:
        ...
        self.conectado_icon = customtkinter.CTkImage(light_image=Image.open(IMG_CONECT_PATH), size=(20,20))
        #self.conectado_icon = customtkinter.CTkImage(light_image=Image.open("conectado.png"), size=(20,20))
        self.desconectado_icon = customtkinter.CTkImage(light_image=Image.open(IMG_DESCON_PATH), size=(15, 15))
        ...
        self.img_carregar = customtkinter.CTkImage(light_image=Image.open(IMG_CRRG_PATH), size=(50,50))
        ...
        def carregar_arquivo():
            ...
            if caminho:
                ...
                logica.enviar_artigos(aceitos, caminho, self.url_ativa, self.key_ativa, self.add_artigo)
